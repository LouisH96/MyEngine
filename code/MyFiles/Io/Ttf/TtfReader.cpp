...
MyEngine::Io::TtfReader::TtfReader(std::istream& stream)
	: m_Reader{ stream }
{
...
MyEngine::Array<MyEngine::Array<MyEngine::Io::Ttf::TtfPoint>> MyEngine::Io::TtfReader::GetPoints(unsigned char c) const
{
...
MyEngine::Io::Ttf::Glyph MyEngine::Io::TtfReader::GetGlyph(char character) const
{
