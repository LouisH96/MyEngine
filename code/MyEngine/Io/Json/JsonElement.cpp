...
const Io::Json::JsonObject& Io::Json::JsonElement::AsObject() const
{
	return *reinterpret_cast<const JsonObject*>(this);
}

const Io::Json::JsonArray& Io::Json::JsonElement::AsArray() const
{
	return *reinterpret_cast<const JsonArray*>(this);
}

const Io::Json::JsonString& Io::Json::JsonElement::AsString() const
{
	return *reinterpret_cast<const JsonString*>(this);
}

const Io::Json::JsonNumber& Io::Json::JsonElement::AsNumber() const
{
	return *reinterpret_cast<const JsonNumber*>(this);
}

Io::Json::ElementType Io::Json::JsonElement::FindElementType(std::ifstream& stream)
{
	char c;
	while (stream.get(c))
	{
...
Io::Json::JsonElement* Io::Json::JsonElement::ReadElement(std::ifstream& stream)
{
