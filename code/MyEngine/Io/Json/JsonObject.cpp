...
bool Io::Json::JsonObject::DetectType(char c)
{
	return c == '{';
}

bool Io::Json::JsonObject::FindNextProperty(std::ifstream& file, std::string& propertyName)
{
	propertyName.clear();
...
bool Io::Json::JsonObject::FindComma(std::ifstream& stream)
{
	char c;
	while (stream.get(c))
	{
