...
void Io::Zlib::ZlibDecompress::Deflate(std::istream& stream)
{
...
uint16_t Io::Zlib::ZlibDecompress::ReadLength(uint16_t code, Binary::BitStream& stream)
{
	if (code <= 264)
		return code - 257 + 3;
	if (code == 258)
...
uint16_t Io::Zlib::ZlibDecompress::ReadDistance(uint8_t code, Binary::BitStream& stream)
{
	if (code <= 3)
		return code + 1;
...
void Io::Zlib::ZlibDecompress::PrintLengthTable()
{
...
void Io::Zlib::ZlibDecompress::PrintDistanceTable()
{
...
std::string Io::Zlib::ZlibDecompress::GetMyTest1Input()
{
...
std::string Io::Zlib::ZlibDecompress::GetInternetExampleInput()
{
	constexpr uint8_t input[]
	{
...
std::string Io::Zlib::ZlibDecompress::GetSalsaTestInput()
{
	uint8_t input[]
	{
...
std::string Io::Zlib::ZlibDecompress::GetLongDutchSentenceTest()
{
	uint8_t input[]
	{
...
bool Io::Zlib::ZlibDecompress::ValidateInternetExampleOutput(const std::string& output)
{
...
bool Io::Zlib::ZlibDecompress::ValidateMyTest1Output(const std::string& output)
{
	constexpr uint8_t desiredOutput[]
	{
