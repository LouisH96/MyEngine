...
Io::Ttf::Glyph::Glyph(const Array<Array<TtfPoint>>& ttfPoints, const Double2& minBounds, const Double2& maxBounds)
...
Double2 Io::Ttf::Glyph::GetSize() const
{
	return m_MaxBounds - m_MinBounds;
}

void Io::Ttf::Glyph::Translate(const Double2& translation)
{
...
void Io::Ttf::Glyph::DebugDraw(const Float3& color, const Float3& offset, int pointsPerCurve) const
{
	for (int i = 0; i < m_Contours.GetSize(); i++)
		m_Contours[i].DebugDraw(color, offset, pointsPerCurve);
}

void Io::Ttf::Glyph::DebugDrawSegments(const Float3& offset, int pointsPerCurve) const
{
	for (int i = 0; i < m_Contours.GetSize(); i++)
