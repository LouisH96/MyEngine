...
void Io::Ttf::CMapTable::Read(const Bin::BigBinReader& reader)
{
...
void Io::Ttf::CMapTable::Print(bool printSubTables) const
{
...
void Io::Ttf::CMapTable::PrintHeader()
{
	std::cout << "___| CMapTable |___\n";
	std::cout << "Version\t|NumberSubTables\n";
}

uint16_t Io::Ttf::CMapTable::GetGlyphIndex(uint16_t codePoint, uint16_t platformId, uint16_t platformSpecificId) const
{
	for (int i = 0; i < m_SubTables.GetSize(); i++)
...
void Io::Ttf::CMapTable::EncodingSubTable::Read(const Bin::BigBinReader& reader)
{
...
void Io::Ttf::CMapTable::EncodingSubTable::ReadFormat(const Bin::BigBinReader& reader)
{
...
void Io::Ttf::CMapTable::EncodingSubTable::Print() const
{
...
void Io::Ttf::CMapTable::EncodingSubTable::PrintHeader()
{
	std::cout << "___| CMapTable::EncodingSubTable |___\n";
	std::cout << "PlatformID\t|PlatformSpecificID\t|Offset\n";
}

uint16_t Io::Ttf::CMapTable::EncodingSubTable::GetGlyphIndex(uint16_t codePoint) const
{
	for (int i = 0; i < m_Format.endCode.GetSize(); i++)
	{
...
void Io::Ttf::CMapTable::Validate() const
{
	for (int i = 0; i < m_SubTables.GetSize(); i++)
