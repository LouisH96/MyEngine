...
Array<Array<Io::Ttf::Segment>> Io::Ttf::ContourOperations::ToSegments(
...
Array<Io::Ttf::Segment> Io::Ttf::ContourOperations::ToSegments(const Array<TtfPoint>& contourPoints)
{
	int nrSegments = 0;
...
void Io::Ttf::ContourOperations::Rasterize(const Glyph& glyph, Rendering::Image& image)
{
...
void Io::Ttf::ContourOperations::AddIntersectionsCurve(const Segment& curve, double height,
	std::vector<Intersection>& intersections)
{
...
void Io::Ttf::ContourOperations::AddIntersectionsLinear(const Segment& linear, double height,
	std::vector<Intersection>& intersections)
{
