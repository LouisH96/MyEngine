...
namespace MyEngine
{
	namespace Rendering
	{
		...
		public:
			...
			explicit R_LambertLight_Tex(Gpu& gpu);
			~R_LambertLight_Tex() = default;

			//---| Rule of five |---
			R_LambertLight_Tex(const R_LambertLight_Tex& other) = delete;
			R_LambertLight_Tex(R_LambertLight_Tex&& other) noexcept = delete;
			R_LambertLight_Tex& operator=(const R_LambertLight_Tex& other) = delete;
