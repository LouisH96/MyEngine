#include "pch.h"
#include "ListPanel2.h"
#include <String\Convert.h>

using namespace MyEngine;
using namespace NewUi;

ListPanel2::ListPanel2(Direction direction, float childMargin, float lineMargin)
	: ListPanel2{ ToFlowDirection(direction), ToFillDirection(direction), childMargin, lineMargin }
{
}

ListPanel2::ListPanel2(const Float2& flowDir, const Float2& fillDir, float childMargin, float lineMargin)
	: m_FlowDir{ flowDir }
	, m_FillDir{ fillDir }
...
void ListPanel2::AddChild(Elem* pChild)
{
	ParentElem::AddChild({ pChild });
}

void ListPanel2::UpdateSizeAndTreePositions(const ResizePref& pref)
{
	m_NrVisibleChilds = 0;
...
void ListPanel2::Clear()
{
}

void ListPanel2::Create()
{
}

void ListPanel2::CreateLineOnOrigin(unsigned& iChild, float& lineFlowSize, float& lineFillSize, bool& isLastLine)
{
	isLastLine = true;
...
Float2 ListPanel2::ToFlowDirection(Direction direction)
{
...
Float2 ListPanel2::ToFillDirection(Direction direction)
{
	const int d{ static_cast<int>(direction) };
