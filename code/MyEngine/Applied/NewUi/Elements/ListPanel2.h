...
namespace MyEngine
{
	namespace NewUi
	{
		...
		public:
			...
			explicit ListPanel2(Direction direction, float childMargin = 5, float lineMargin = 5);
		...
		private:
			...
			explicit ListPanel2(const Float2& flowDir, const Float2& fillDir, float childMargin, float lineMargin);
