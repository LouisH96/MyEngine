...
void FontRenderer::OnCanvasResized(const App::ResizedEvent& event)
{
...
Float2 FontRenderer::GetSize(const std::string& text, float height, float spacing)
{
...
Float2 FontRenderer::GetBiggestSize(const std::string* pText, unsigned count, float height, float spacing)
{
	Float2 biggest{};
