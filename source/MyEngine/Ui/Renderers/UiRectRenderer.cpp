...
void UiRectRenderer::Remove(unsigned id)
{
	m_Instances[id].Invalidate();
}

unsigned UiRectRenderer::Add(RectFloat rect, const Float3& color)
{
...
void UiRectRenderer::SetColor(unsigned id, const Float3& color)
{
