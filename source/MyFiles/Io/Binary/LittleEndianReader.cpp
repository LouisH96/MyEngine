...
uint64_t MyEngine::Io::Binary::LittleEndianReader::Uint64() const
{
...
uint16_t MyEngine::Io::Binary::LittleEndianReader::Uint16() const
{
	return Uint16(m_Stream);
}

uint16_t MyEngine::Io::Binary::LittleEndianReader::Uint16(std::istream& stream)
{
...
uint64_t MyEngine::Io::Binary::LittleEndianReader::Uint64(std::istream& stream)
{
